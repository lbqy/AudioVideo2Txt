...
CHECKPOINT_PATH="${CHECKPOINT_PATH:-$PROJECT_DIR/exp/assign_feature_mask_av2t/checkpoints/checkpoint_best.pt}"
RESULT_PATH="${RESULT_PATH:-$PROJECT_DIR/exp/eval_assign_feature_mask_av2t}"
